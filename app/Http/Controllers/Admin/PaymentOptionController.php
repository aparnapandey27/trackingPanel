    ...
    if ($request->ajax()) {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function (PaymentOption $paymentOption) {
                $editButton = '<a href="javascript:void(0)" onclick="editPaymentMethod(' . $paymentOption->id . ')" class="btn btn-info btn-sm mb-2">
                ...
                $deleteButton = '<a href="javascript:void(0)" data-toggle="tooltip" onclick="deletePaymentMethod(' . $paymentOption->id . ')" data-original-title="Delete" class="btn btn-danger btn-sm mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
            ...
            ->addColumn('checkbox', function ($row) {
                return '<input type="checkbox" name="offer_checkbox[]" class="checkbox c-checkbox offer_checkbox" value="' . $row->id . '" />';
            })
...
// {
//     $paymentOptions = PaymentOption::all(); // Or use query builder as needed
//     return response()->json([
//         'draw' => request('draw'),
//         'recordsTotal' => $paymentOptions->count(),
//         'recordsFiltered' => $paymentOptions->count(),
//         'data' => $paymentOptions
//     ]);
// }
