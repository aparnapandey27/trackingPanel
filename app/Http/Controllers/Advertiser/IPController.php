...
class IPController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->editColumn('ipaddress', function (IP $ipaddr) {
                    $ipaddress = '<a title="' . $ipaddr->ipaddress . '" style="text-decoration:none" href="' . route('advertiser.ip.show', $ipaddr->id) . '">' . $ipaddr->ipaddress . '</a>';
               ...
               ->rawColumns(['action', 'status','ipaddress'])
                ->make(true);
        }
        return view('advertiser.ip.index');
    }
    ...
    public function create()
    {
        ...
        return view('advertiser.ip.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $ipaddr->advertiser_id = auth()->user()->id;
      
        $ipaddr->status = $request->status;
        $ipaddr->save();

        Toastr::success('IP Address Added Successful', 'Success');
        return redirect()->route('advertiser.ip.index')->with('success', 'IP Address created successfully');
    ...
    public function show($id)
    {
        ...
        return view('advertiser.ip.show', compact('ipaddr'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('advertiser.ip.edit', compact('ipaddr'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('advertiser.ip.show', $ipaddr->id);
    }
