...
class OfferStudentController extends Controller
{
    ...
    {
        $offer = Offer::find($id);
        return view('employee.offerStudent.create', compact('offer'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('employee.offer.show', $request->offer_id);
        }
        catch (\Exception $e) {
    ...
    public function edit($offerid, $studentid)
    {
        ...
        return view('employee.offerStudent.edit', compact(['offer','offerStudent']));
    }
    
    public function update(Request $request, $offerid, $studentid)
    {
        $request->validate([
           'student_id'=>'required',
            'goal_name' => 'required',
        ...
        return redirect()->route('employee.offer.show', $offerid);
    }
