...
<div class="page-content">
	<div class="container-fluid">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-4">{{__('Conversion')}}</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item">
                        <a href="javascript: void(0);">{{__('Report')}}</a>
                    </li>
                    <li class="breadcrumb-item active">{{__('Conversion')}}</li>
                </ol>
            </div>
        </div>
        <form action="{{ route('admin.report.conversion') }}" method="GET" id="report-form">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-11">
                        <div class="row mb-4">
                            ...
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                <input  type="checkbox" id="advertiser_id" name="data[advertiser_id]" value="1"
                                    <?= in_array('Advertiser ID', $headers) ? "checked='checked'" : '' ?>>
                                <label for="advertiser_id">Advertiser ID</label>
                            </div>
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                <input  type="checkbox" id="advertiser" name="data[advertiser]" value="1"
                                    <?= in_array('Advertiser', $headers) ? "checked='checked'" : '' ?>>
                            ...
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                <input  type="checkbox" id="paytm_no" name="data[paytm_no]" value="1"
                                    <?= in_array('Paytm No', $headers) ? "checked='checked'" : '' ?>>
                                <label for="student_id">Paytm No</label>
                            </div>
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        ...
                        <div class="row">
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                <input  type="checkbox" id="goal" name="data[goal]" value="1"
                                    <?= in_array('Goal Name', $headers) ? "checked='checked'" : '' ?>>
                            ...
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                <input  type="checkbox" id="statistics_revenue" name="statistics[revenue]" value="1"
                                    <?= in_array('Revenue', $headers) ? "checked='checked'" : '' ?>>
                                <label for="statistics_revenue">Revenue</label>
                            </div>
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                <input  type="checkbox" id="statistics_profit" name="statistics[profit]" value="1"
                                    <?= in_array('Profit', $headers) ? "checked='checked'" : '' ?>>
                                <label for="statistics_profit">Profit</label>
                            </div>
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                            ...
                            <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                <input  type="checkbox" id="datetime" name="data[datetime]" value="1"
                                    <?= in_array('DateTime', $headers) ? "checked='checked'" : '' ?>>
                                <label for="datetime">Conversion Date</label>
                            </div>
        ...
        <div class="row g-3 mb-4 align-items-center">
            ...
            <div class="card shadow-lg border-left-dark">
                <div class="card-header">
                    <h6 class="card-title mb-0 flex-grow-1 text-primary">{{ __('Conversion') }}</h6>
                </div>
                <div class="card-body">
                    @if (isset($records))
                            <div class="table-responsive">
                                <table class="table table-striped" id="conversion">
