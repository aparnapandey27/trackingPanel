...
<div class="page-content">
	<div class="container-fluid">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-4">{{__('Performance')}}</h4>
        ...
        <form action="{{ route('admin.report.performance') }}" method="GET" id="report-form">
                        ...
                        <div class="col-md-11">
                            <div class="row">
                                ...
                                <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                    ...
                                    <label for="statistics_revenue">Revune</label>
                                </div>
                                <div class="form-group-column col-lg-2 col-md-3 col-sm-4 col-xs-6">
    ...
    @push('scripts')
        ...
        <script type="text/javascript" src="{{ asset('assets/libs/bootstrap-daterangepicker/daterangepicker.js') }}">
        </script>
