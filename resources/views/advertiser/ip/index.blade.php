        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-sm-auto ms-auto">
                            <a class="btn btn-primary btn-lg" href="{{ route('advertiser.ip.create') }}">Add IP Address</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-lg border-left-dark">
                <div class="card-header">
                    <h6 class="card-title mb-0 flex-grow-1 text-primary">All IP Whitelisted</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-borderles ipaddr" id="ipaddr">
...
@push('scripts')
    ...
    <script>
        $(function() {
            $('#ipaddr').DataTable({
                ...
                ajax: '{{ route('advertiser.ip.index') }}',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
    ...
    <script>
        function updateStatus(id, status) {
            ...
            let _url = `/advertiser/ip/status/${id}`;
            Swal.fire({
                title: 'Confirmation?',
