                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-4">Sign in</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="card-footer text-center">
                                <div class="row">
                                    <div class="col-6">
                                        <a href="{{ route('register') }}" class="btn btn-primary w-100">Student Signup</a>
                                    </div>
                                    <div class="col-6">
                                        <a href="http://127.0.0.1:8000/advertisers/register" class="btn btn-secondary w-100">Advertiser Signup</a>
                                    </div>
                                </div>
                            </div>
                        </div>
