    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{__('Student Click Limit Details')}}</h4>
            ...
            <div class="card mb-4 shadow-lg border-left-dark">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('employee.offer.clicklimit.update', [$clicklimit->offer_id, $clicklimit->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row mb-3" id="clicklimit_group">
