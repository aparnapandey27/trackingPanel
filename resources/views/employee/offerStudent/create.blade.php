            ...
            <div class="card mb-4 shadow-lg border-left-dark">
                ...
                <form action="{{ route('employee.offer.student.store') }}" method="POST">
                    ...
                    <div class="form-group row mb-3" id="student_id">
                        ...
                        <select class="form-select student" data-placeholder="Choose any Student to Generate its Payout" >
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select" name="goal_name" id="goal_name">
                                ...
                                <option value="{{ $goal->name }}" data-pay-model="{{ $goal->offer_model }}" data-currency="{{ $goal->currency }}" data-default-payout="{{ $goal->default_payout }}" data-percent-payout="{{ $goal->percent_payout }}">{{ $goal->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
