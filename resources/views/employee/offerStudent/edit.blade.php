    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="card mb-4 shadow-lg border-left-dark">
                ...
                <div class="card-body">
                    <form action="{{ route('employee.offer.student.update', [$offerStudent->offer_id, $offerStudent->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="goal_name" id="goal_name">
                                    ...
                                    <option value="{{ $goal->name }}" data-pay-model="{{ $goal->offer_model }}" data-currency="{{ $goal->currency }}" data-default-payout="{{ $goal->default_payout }}" data-percent-payout="{{ $goal->percent_payout }}"
                                    {{ $offerStudent->name == $goal->name ? 'selected' : '' }} >{{ $goal->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
