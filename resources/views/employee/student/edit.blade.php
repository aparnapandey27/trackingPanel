    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{__('Edit Student')}}</h4>
            ...
            <div class="card shadow-lg border-left-dark">
                <div class="card-header">
                    <h6 class="card-title mb-0 flex-grow-1 text-primary">Edit Student</h6>
                </div>
                @if ($errors->any())
                ...
                @endif
                <form action="{{ route('employee.student.update', $user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body row justify-content-center mx-4">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class=" form-group mb-3">
                                        <label for="company">College Name</label>
                                        <input type="text" class="form-control" name="company" id="company" required
                                            placeholder="College Name" value="{{ $user->company }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class=" form-group mb-3">
                            ...
                            <div class=" form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="address" id="address" required
                                    placeholder="Address Line 1" value="{{ $user->address }}">
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class=" form-group mb-3">
                                        ...
                                        <select id="country" name="country" class="form-control country">
                                            <option disabled selected>Choosee...</option>
                            ...
                            <div class=" form-group mb-3">
                                ...
                                <select name="status" class=" form-control status">
                                    ...
                                    <option value="1" {{ $user->status == 2 ? 'selected' : '' }}>Rejcted</option>
                                    <option value="1" {{ $user->status == 3 ? 'selected' : '' }}>Closed</option>
                                </select>
                            </div>
