          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                    ...
                    <div class="form-check form-switch">
                      ...
                      <div class="card-footer text-center pt-0 px-lg-2 px-1">
                        <small class="text-muted">
                          <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">Forget password</a>
                        </small>
                        </div>
                ...
                <div>
                  <a href="{{ route('students.signup') }}" class="btn btn-primary waves-effect waves-light">Student Signup </a>
                  <a href="http://127.0.0.1:8000/advertisers/register" class="btn btn-primary waves-effect waves-light">Advertiser Signup</a>
                </div>
