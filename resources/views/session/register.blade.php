      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Get your Student account now.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="row mb-3">
                  <div class="col-sm-6">
                    <input type="text" name="company" class="form-control" id="exampleFirstName" placeholder="College Name" value="{{ old('company') }}">
                    @error('company')
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="student_name" class="form-control" id="exampleStudentName" placeholder="Student Name" value="{{ old('student_name') }}">
                    @error('student_name')
                      <div class="invalid-feedback d-block" role="alert">
                        <strong>{{ $message }}</strong>
                      </div>
                  ...
                  <div class="mb-3 row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control" id="exampleFirstName" placeholder="Phone" name="phone" required value="{{ old('phone') }}"> @error('phone') <div class="invalid-feedback d-block" role="alert">
                            <strong>{{ $message }}</strong>
                        </div> @enderror
                    </div>
                  </div>
                  ...
                  <div class="mb-3">
                    <input type="password" name="password_confirmation" class="form-control" placeholder="Confirm Password" aria-label="Password Confirmation">
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" id="exampleInputEmail" name="address" placeholder="Address" value="{{ old('address') }}"> @error('address') <div class="invalid-feedback d-block" role="alert">
                        <strong>{{ $message }}</strong>
                    </div> @enderror
                </div>
                <div class="mb-3 row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                      <input type="text" class="form-control" id="exampleInputPassword" name="city" placeholder="City" value="{{ old('city') }}"> @error('city') <div class="invalid-feedback d-block" role="alert">
                          <strong>{{ $message }}</strong>
                      </div> @enderror
                  </div>
